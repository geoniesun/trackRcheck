...
minimumpoints <- st_read("minimumpoints.gpkg")

side1_extent <- st_read("side1_extent.gpkg")
 side2_extent <- st_read("side2_extent.gpkg")
...
#'
#' @examples
maptrack <- function(raster, minimumpoints, tracks, side1_extent=NULL, side2_extent=NULL) {
...
maptrack(raster, minimumpoints, tracks, side1_extent = side1_extent, side2_extent = side2_extent)
